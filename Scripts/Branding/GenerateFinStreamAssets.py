...
try:
    ...
    raise SystemExit(
        "GenerateFinStreamAssets.py requires Pillow. "
...
ASSETS = ROOT / "Swiftfin tvOS/Resources/Assets.xcassets"
BRAND = ASSETS / "App Icon & Top Shelf Image.brandassets"
PREVIEW = ROOT / "docs/finstream-logo-assets-preview.png"
...
LOGO_TARGETS = [
    ("finstream-logo.png", (100, 60)),
    ("finstream-logo@2x.png", (200, 120)),
    ("finstream-logo@3x.png", (300, 180)),
]
...
def save_logo_assets():
    logo_dir = ASSETS / "finstream-logo.imageset"
...
def save_preview():
    ...
    draw.text((80, 62), "FinStream Subtle Nod Asset Set", font=title_font, fill=(255, 255, 255))

    logo = Image.open(ASSETS / "finstream-logo.imageset/finstream-logo@3x.png").convert("RGBA")
...
def main():
    ...
    save_preview()
    print("Generated FinStream logo and tvOS assets.")
