...
extension UserDefaults {
    ...
    static let appSuite: UserDefaults = {
        guard let suite = UserDefaults(suiteName: "watermelonfinApp") else {
            logger.critical("Failed to create appSuite, falling back to .standard", metadata: ["suite": "watermelonfinApp"])
            return .standard
        }
        return suite
    }()
...
extension Defaults.Keys {
    ...
    static var accentColor: Key<Color> = AppKey("accentColor", default: .watermelonRed)
...
extension Defaults.Keys {
    ...
    static var userAccentColor: Key<Color> {
        UserKey("userAccentColor", default: .watermelonRed)
    }
    ...
    enum VideoPlayer {
        ...
        static let videoPlayerType: Key<VideoPlayerType> = UserKey("videoPlayerType", default: .watermelonfin)
...
extension UserDefaults {
    ...
    static let debugSuite: UserDefaults = {
        guard let suite = UserDefaults(suiteName: "watermelonfinstore-debug-defaults") else {
            logger.critical(
                "Failed to create debugSuite, falling back to .standard",
                metadata: ["suite": "watermelonfinstore-debug-defaults"]
            )
            return .standard
        }
        return suite
