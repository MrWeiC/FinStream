...
extension VideoPlayerType {
    ...
    static var _watermelonfinDirectPlayProfiles: [DirectPlayProfile] {
    ...
    static var _watermelonfinTranscodingProfiles: [TranscodingProfile] {
        TranscodingProfile(
    ...
    static var _watermelonfinSubtitleProfiles: [SubtitleProfile] {
    ...
    static var _watermelonfinCodecProfiles: [CodecProfile] {
        CodecProfile(
