...
/// Handles OAuth authentication for YouTube Music via FinStream Auth Bridge
///
...
public final class YTMusicAuth: ObservableObject {
    ...
    /// FinStream Auth Bridge endpoints - handles the web OAuth flow for tvOS
    private enum Bridge {
    ...
    /// Start the authentication process via FinStream Auth Bridge
    ///
    ...
    /// Request a code from the FinStream Auth Bridge
