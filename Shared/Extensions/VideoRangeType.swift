...
extension VideoRangeType: Displayable {
    ...
    var isHDR: Bool {
        ...
        case .hdr10, .hlg, .hdr10Plus,
             .dovi, .doviWithEL, .doviWithELHDR10Plus, .doviWithHDR10,
             .doviWithHDR10Plus, .doviWithHLG, .doviWithSDR:
            return true
        default:
            return false
        }
    ...
    var isDolbyVision: Bool {
        switch self {
        case .dovi, .doviWithEL, .doviWithELHDR10Plus, .doviWithHDR10,
             .doviWithHDR10Plus, .doviWithHLG, .doviWithSDR:
            return true
        default:
            return false
